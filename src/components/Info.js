...
export default class Info extends Component {
    ...
    render() {
        ...
        let url = "http://" + getUrl();
        let quote = "MapPuzzle.gl is an experimental website, it is an accessible way to learn cartography, through this project we try to offer an interactive learning experience with maps."
                ...
                <Modal.Body>
                    <Row>
                        <Col lg={12} className="info">
                            <p>MapPuzzle.gl is an experimental website, developed with React and Deck.gl. It is an accessible way to learn cartography, through this project I try to offer an interactive learning experience with maps.</p>
                            ...
                            <p>It also has a counter of pieces found, pieces to be searched for and faults committed.</p>
                            <h2>Credits</h2>
                            {Puzzles}
                            <p>More info in <a href="https://aaranda.es/en/mappuzzle-gl-en/" target="_blank" rel="noreferrer noopener">aaranda.es</a></p> 
                        </Col>
                    </Row>
                    <Row>
