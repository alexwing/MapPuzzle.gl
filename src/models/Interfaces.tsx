...
export interface PieceProps {
  ...
  properties: {
    ...
    latitude: number;
    /**
     * SVG `viewBox` and path, pre-generated by PostGIS in older maps. Both are
     * derived from `geometry` at runtime now (see lib/pieceSilhouette) and are
     * only read as a fallback, so newer maps can omit them.
     */
    box?: string;
    poly?: string;
  };
